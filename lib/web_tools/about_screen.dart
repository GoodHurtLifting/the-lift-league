...
class AboutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('POSS Block Builder')),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              RichText(
                text: const TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                      text:
                          '   Craft as many workouts as you like, arrange them into training blocks, and store everything in-browser—no downloads, no exports.\n\n',
                    ),
                  ],
                ),
              ),
              ...
              const Text('Powered by The Lift League',
                style: TextStyle(
                    fontSize: 10,
