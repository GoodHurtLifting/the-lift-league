...
class PromoPopupService {
  ...
  static const _messages = [
    ...
    'Invite friends to run your custom blocks in the mobile app and start your own leaderboard!',
    'Blocks you build here are already waiting for you in The Lift League app—pick up right where you left off!',
    ...
    'Track stats in The Lift League app: BMI, Weight, Body% with check-ins.'
    ...
    'Drop a ‘clink’ after a great session and connect with your training circle—try the app!',
